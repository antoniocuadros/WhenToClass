...
class TestApi < Minitest::Test
    ...
    MONGODator.stub(:new, FSDator.new("../data")) do
        a_anadir = @grado
        put '/grados/0e78a27a1e605334c0ba', a_anadir.to_json    
            res = {"añadido"=>"0e78a27a1e605334c0ba"}
            res = res.to_json
            assert_equal(last_response.content_type, 'application/json')
            assert_equal(last_response.location, '/grados/0e78a27a1e605334c0ba')
            assert_equal(last_response.body, res)
        delete '/grados/0e78a27a1e605334c0ba' 
    end
    end
    ...
    MONGODator.stub(:new, FSDator.new("../data")) do
        ...
        get '/grados/0e78a27a1e605334c0ba' 
            res = a_anadir
            res = res.to_json
            assert_equal last_response.status, 200
            assert_equal(last_response.content_type, 'application/json')
    ...
    MONGODator.stub(:new, FSDator.new("../data")) do
        ...
        #Probamos a consultar
        get '/grados/0e78a27a1e605334c0ba/asignatura/50bbd28fa87ba567f7bd' 
            res = @asignatura
            res = res.to_json
            assert_equal last_response.status, 200
            assert_equal(last_response.content_type, 'application/json')
    ...
    MONGODator.stub(:new, FSDator.new("../data")) do
        #Probamos a consultar
        get '/grados/0e78a27a1e605334c0ba/asignatura/123' 
    ...
    MONGODator.stub(:new, FSDator.new("../data")) do
        ...
        #Probamos a eliminar
        delete '/grados/0e78a27a1e605334c0ba/asignatura/50bbd28fa87ba567f7bd' 
    ...
    MONGODator.stub(:new, FSDator.new("../data")) do
        ...
        get '/grados/0e78a27a1e605334c0ba/asignatura/50bbd28fa87ba567f7bd/horario?grupo=P1' 
    ...
    MONGODator.stub(:new, FSDator.new("../data")) do
        ...
        #Probamos a consultar horario
        get '/grados/0e78a27a1e605334c0ba/asignatura/50bbd28fa87ba567f7bd/horario' 
    ...
    MONGODator.stub(:new, FSDator.new("../data")) do
        ...
        get '/grados/0e78a27a1e605334c0ba/asignatura/50bbd28fa87ba567f7bd/enlace?grupo=P1' 
    ...
    MONGODator.stub(:new, FSDator.new("../data")) do
        ...
        #Probamos a consultar enlaces
        get '/grados/0e78a27a1e605334c0ba/asignatura/50bbd28fa87ba567f7bd/enlace' 
            res = {"error"=>"es necesario pasar la variable grupo"}
            res = res.to_json
            assert_equal last_response.status, 404
            assert_equal(last_response.content_type, 'application/json')
    ...
    MONGODator.stub(:new, FSDator.new("../data")) do
        ...
        get '/grados/0e78a27a1e605334c0ba/asignatura/50bbd28fa87ba567f7bd/turno?turno=1&mes=dec' 
    ...
    MONGODator.stub(:new, FSDator.new("../data")) do
        ...
        #Probamos a consultar turnos
        get '/grados/0e78a27a1e605334c0ba/asignatura/50bbd28fa87ba567f7bd/turno' 
    ...
    MONGODator.stub(:new, FSDator.new("../data")) do
        ...
        get '/grados/0e78a27a1e605334c0ba/asignaturas' 
